// ============================================================
// FOOTER — Clean and understated
// Replace [PLACEHOLDERS] with your actual links and info
// ============================================================
        ...
        <div className="flex items-center gap-4">
          {socialLinks.map((link) => (
            <a
              ...
              className="text-secondary hover:text-interactive transition-colors duration-200"
