...
export default function RecruiterAccess() {
  return (
    <section
      ...
      aria-label="Quick access links for recruiters"
    >
        ...
        <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
          {links.map((link, i) => (
            <motion.a
              ...
              className="group glass rounded-2xl p-6 text-center flex flex-col items-center gap-4 transition-all duration-300 hover:border-interactive/40 hover:shadow-xl hover:shadow-interactive/10 hover:-translate-y-1"
              aria-label={`${link.title} — ${link.description}`}
            >
              <div className="text-interactive transition-transform duration-300 group-hover:scale-110">
                {link.icon}
              </div>
